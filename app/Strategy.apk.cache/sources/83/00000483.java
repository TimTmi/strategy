...
public final class UnsignedKt {
    ...
    public static final int m373uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m120constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m374uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m120constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m375ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m198constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        } else if (v1 >= 0) {
            return ULong.m198constructorimpl(v1 / v2);
        } else {
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            return ULong.m198constructorimpl((ulongCompare(ULong.m198constructorimpl(rem), ULong.m198constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m376ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            ...
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            if (ulongCompare(ULong.m198constructorimpl(rem), ULong.m198constructorimpl(v2)) >= 0) {
                j = v2;
            }
            return ULong.m198constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        if (!Double.isNaN(v) && v > uintToDouble(0)) {
            ...
            return v <= 2.147483647E9d ? UInt.m120constructorimpl((int) v) : UInt.m120constructorimpl(UInt.m120constructorimpl((int) (v - ((double) IntCompanionObject.MAX_VALUE))) + UInt.m120constructorimpl(IntCompanionObject.MAX_VALUE));
        }
        return 0;
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0L)) {
            ...
            return v < 9.223372036854776E18d ? ULong.m198constructorimpl((long) v) : ULong.m198constructorimpl(ULong.m198constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
