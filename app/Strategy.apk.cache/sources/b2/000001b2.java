...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(CharSequence text, Params params) {
        ...
        try {
            ...
            if (i2 >= 23) {
                StaticLayout.Builder.obtain(text, 0, text.length(), params.getTextPaint(), IntCompanionObject.MAX_VALUE).setBreakStrategy(params.getBreakStrategy()).setHyphenationFrequency(params.getHyphenationFrequency()).setTextDirection(params.getTextDirection()).build();
            } else if (Build.VERSION.SDK_INT >= 21) {
                new StaticLayout(text, params.getTextPaint(), IntCompanionObject.MAX_VALUE, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
